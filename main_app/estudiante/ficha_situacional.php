...
<main id="ficha_situacional">
   <form id="form_ficha_situacional">
   <input type="hidden" name="este_alumno" id="este_alumno_ficha">
   <center>
    <table class="table-responsive" BORDER WIDTH="90%" border=1>
        ...
        <tr>
           ...
           <td colspan="2"><input id="Apellidos_ficha" class="largo" type="text" name="Apellidos"></td>
           <td style ="background: #F0CFAE" border width ="15%" colspan="2">Nombres </td>
           <td colspan="2"><input id="Nombre_ficha" class="largo" type="text" name="Nombres"></td>
        </tr>
        <tr>
           <td style ="background: #F0CFAE" border width ="5%">GRADO</td>
           <td><select  class ="largo" name="grado">
                  <option value=""></option>
                  <option value="Inicial Grupo 3Años">Inicial Grupo 3Años</option>
                  <option value="Inicial Grupo 4Años">Inicial Grupo 4Años</option>
                  <option value="Preparatoria 1Grado">Preparatoria 1Grado</option>
                  <option value="2Grado">2Grado</option>
                  <option value="3Grado">3Grado</option>
                  <option value="4Grado">4Grado</option>
                  <option value="5Grado">5Grado</option>
                  <option value="6Grado">6Grado</option>
                  <option value="7Grado">7Grado</option>
                </select>
       ...
       <tr>
           ...
           <td colspan="3"><input  class ="largo" type="text" name="nom_madre"></td>
        ...
        <tr>
            ...
            <td style ="background: #6698F1" border width ="10%">Caracteristicas_1</td>
            <td colspan="2"><input type="text" class="largo" name="caracteristica_enfermedad1"></td>
        </tr>
        <tr>
            ...
            <td style ="background: #6698F1" border width ="10%">Caracteristicas_2</td>
            <td colspan="2"><input type="text" class="largo" name="caracteristica_enfermedad2"></td>
        </tr>
        <tr>
            ...
            <td style ="background: #6698F1" border width ="10%">Caracteristicas_3</td>
            <td colspan="2"><input type="text" class="largo" name="caracteristica_enfermedad3"></td>
        </tr>
        <tr>
        ...
        <tr align = center>
            <td style ="background: #E7C715;" colspan="5"><b>Conductas familiares presentadas en el hogar</b></td>   
        ...
        <tr>
            ...
            <td rowspan="12" colspan="2"><p>
                ...
                <input type="checkbox" name="colaboracion" value="X" >Hay colaboración familiar<br>
                <input type="checkbox" name="comunicacion" value="X" >Comunicación asertiva<br>
        ...
        <tr align = center>
            <td style ="background: #C663BE;" colspan="3"><b>Caracteristicas de aprendizaje</b></td>   
            <td style ="background: #C663BE;" colspan="3"><b>Dificultades de aprendizaje</b></td> 
        ...
        <tr>
            <td style ="background: #E8F5A1" colspan="8"><b>OBSERVACIONES: Designar el representante legal del estudiante </b> 
            </td>    
        </tr>
        <tr>
        ...
        <tr align = center>
            <td colspan="8"><button type="submit" class="btn btn-primary" id="btn_ficha_envia">ENVIAR INFORMACIÓN </button></td>
        </tr>
