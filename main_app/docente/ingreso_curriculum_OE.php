...
<main id="OE">
    ...
    <table class ="table-responsive" BORDER WIDTH="100%" border=1 >
        ...
        <tr>
            <td colspan="2"> <textarea name="OE" id="editor" class ="largo w-100" rows="10"></textarea></td>
        </tr>
        <tr align = center >
            <td ><button type="submit" class="btn btn-success" id="btn_OE_enviar">ENVIAR INFORMACIÓN </button></td>
