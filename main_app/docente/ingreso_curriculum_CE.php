...
<main id="CE">
    ...
    <table class ="table-responsive" BORDER WIDTH="100%" border=1 >
        <tr align = center>
           <td style ="background: #9F6DED; " colspan="2"> Ingreso de Criterios de Evaluación (CE)</td>           
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"> <textarea name="CE" id="editor_CE" class ="largo w-100" rows="10"></textarea></td>
        </tr>
        <tr align = center >
