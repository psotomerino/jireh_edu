<?php
    ...
    include 'lista_estu_doc_2021.php';
    include 'estudiante_2021.php';
   ...
   <aside id="aside_left"> 
    ...
    <div class="container" id="escritorio">
           <ul>
               ...
               <li><div class="title"><a href="#" class="btn btn-default btn-lg active" id="btn_informes" role="
               "> INFORMES <br><img src="../../imagenes/con_cupo.jpg" class=" w-75" alt=""></a></div></li>   
...
<footer></footer>
<script src="../../js/app_docente_2021.js"></script>
<script src="../../js_notas_2021/notas_2021.js"></script>
<script src="../../js_notas_2021/imprime_boleta_2021.js"></script>
<script src="../../js_informes/promedio_anual.js"></script>