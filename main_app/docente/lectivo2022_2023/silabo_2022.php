        ...
        <form id="form_sib">
            <div id="datos_sub">
                ...
                <select class="form-control" id="mi_grado" name="mi_grado">
                    ...
                    <option value="10">Séptimo grado</option>
                </select> 
                <select id="lista_asignatura_sib" name="asignatura" class="form-control"></select>    
            </div>       
            
            <textarea name="text_sib" id="text_sib_2022"> <!--editor_4-->
            ...
            <p style="margin-left:80px"><strong><span>Docente</span><br>Docente</strong></p>
            ...
            <p style="margin-left:80px"><strong><span>__________</span><br>Coordinador Académico</strong></p>
...
<script type="text/javascript" src="lectivo2022_2023/js/silabo.js"></script>
