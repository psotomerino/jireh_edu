...
<main id="IE">
    ...
    <table class ="table-responsive" BORDER WIDTH="100%" border=1 >
        <tr align = center>
           <td style ="background: #59EE6B; " colspan="2"> Ingreso de Indicador  de Evaluación (IE)</td>           
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"> <textarea name="IE" id="editor_IE" class ="largo w-100" rows="10"></textarea></td>
        </tr>
        <tr align = center >
            <td ><button type="submit" class="btn btn-success" id="btn_IE_enviar">ENVIAR INFORMACIÓN </button></td>
