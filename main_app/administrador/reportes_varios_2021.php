    ...
    <nav class="menuCSS3">
		<ul>
			...
			<li><a href="#">Certificados </a>
				<ul>
					<li><a href="#" id="Cer_ma_">Matrícula 2021 - 2022</a></li>
...
<div class = "cuerpo_A4">
        ...
        <p class= "parrafo"><b>CERTIFICAMOS QUE:</b> El/la  niño(a) <b id="nombres_certificado"></b>&nbsp;<b id="apellidos_certificado"></b>. <h7>Previo el cumplimiento de los correspondientes requisitos legales y reglamentos en vigencia se matriculó en el curso, nivel y año lectivo que a continuaciòn se detalla:</h7></p><br>
...
<script>
    ...
    day = date.getDate();
    document.getElementById("current_date".innerHTML="Tena a los: "+ day + " días del mes " + month + " del " + year);*/
</script>
 
<script src="../../js/certificado_mat_2020.js"></script>
<script src="../../js/reportes_varios_admin_2021.js"></script>
