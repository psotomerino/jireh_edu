<?php
    ...
    if ($result = $mysqli->query("SELECT * FROM `notas_proyIntegral_1q` where id_asignatura = $id_asignatura and id_usuario = $id_usuario")) {
    ...
    if ($row_cnt == 1){
       printf("La materia ya está asignada una calificación.\n", $row_cnt); 
        ...
        //echo 'vamos bien';
        $inserta_notas ="INSERT INTO notas_proyIntegral_1q(
                            id_ano_lectivo,
                            id_usuario,
                            id_quimestre,
                            id_parciales,
